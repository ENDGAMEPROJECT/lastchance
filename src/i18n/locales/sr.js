  ...
  "rooms": {
    ...
    "algorithm": {
      ...
      "report": {
        ...
        "columns": {
          "time": "VREME",
          "activity": "AKTIVNOST KORISNIKA",
          "interpretation": "TUMAČENJE ALGORITMA"
        },
        "entries": [
          {
            "text": "Korisnik je kliknuo na oglas.",
            "result": "ZAINTERESOVAN"
          },
          {
            "text": "Ostao je na stranici proizvoda 2 minuta.",
            "result": "ZAINTERESOVAN"
          },
          {
            "text": "Video je 7 novih recenzija.",
            "result": "ZAINTERESOVAN"
          },
          {
            "text": "Korisnik je zatvorio prozor.",
            "result": "IZGUBIO INTERESOVANJE"
          },
          {
            "text": "Korisnik je kliknuo na drugi oglas istog brenda.",
            "result": "POVRATAK"
          },
          {
            "text": "Korisnik skroluje 4 minuta.",
            "result": "TRAŽI JOŠ"
          },
          {
            "text": "Dodao je 1 artikl u korpu.",
            "result": "SIGNAL INTERESOVANJA"
          },
          {
            "text": "Proveo je 8 minuta na istoj stranici.",
            "result": "OKLEVANJE"
          },
          {
            "text": "Pokrenuta je posebna ponuda / intervencija odbrojavanja.",
            "result": "KONVERZIJA"
          },
          {
            "text": "Kupio je 1 artikl.",
            "result": "KUPOVINA"
          }
        ]
      },
